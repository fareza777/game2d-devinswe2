...
UI_STRINGS = {
    ...
    # Saltwold Grange: the Salt League's weigh-court — Hask's scales, Collum's bays, Lene's gate.
    ...
    "place.Grange": ("Saltwold Grange", "Lumbung Saltwold"),
    "prompt.travel.grange": ("Take the toll lane to Saltwold Grange", "Tempuh lajur tol ke Lumbung Saltwold"),
    "prompt.travel.grangeOut": ("Walk back down the lane to the trade road", "Kembali menyusuri lajur ke jalan dagang"),
    "event.grange.bays": ("Deserter-foragers squat the bays.", "Perampok bayaran menduduki kandang-kandang."),
    "event.grange.key": ("The key-warden's 'guests' object.", "'Tamu-tamu' penjaga kunci berkeberatan."),
    "toast.grangeBays": ("The bays stand clear", "Kandang-kandang sudah bersih"),
    "hud.level": ("LV {0}", "LV {0}"),
