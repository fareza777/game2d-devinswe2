...
UI_STRINGS = {
    ...
    "menu.about": ("About", "Tentang"),
    "about.title": ("Oathfire", "Oathfire"),
    "about.body": ("A tale of the last warden and the valley that would not go dark.\n\nWritten in ink and ash · Chapter I: The Ember Vigil\n\nMade with Unity. Voices by ElevenLabs. Art and music rendered in the woodcut-codex style.", "Kisah warden terakhir dan lembah yang menolak padam.\n\nDitulis dengan tinta dan abu · Babak I: Vigil Bara\n\nDibuat dengan Unity. Suara oleh ElevenLabs. Seni dan musik bergaya cukil kayu kodeks."),
    "about.share": ("Share the tale", "Bagikan kisahnya"),
    "about.rate": ("Rate on Play Store", "Beri nilai di Play Store"),
    "about.shareText": ("Oathfire — a woodcut tale of the last warden. https://play.google.com/store/apps/details?id={0}", "Oathfire — kisah cukil kayu sang warden terakhir. https://play.google.com/store/apps/details?id={0}"),
    "about.removeAds": ("Remove every ad · {0}", "Hapus semua iklan · {0}"),
    "about.removed": ("The valley is quiet — ads removed", "Lembah sudah tenang — iklan dihapus"),
    "about.restore": ("Restore purchases", "Pulihkan pembelian"),
    ...
    "hud.pack": ("PACK", "TAS"),
    "hud.menu": ("MENU", "MENU"),
    "menu.title": ("The Road Waits", "Jalan Menunggu"),
    "menu.resume": ("Continue", "Lanjutkan"),
    ...
    "speaker.wren": ("Kiln-keeper Wren", "Wren Penjaga Tungku"),
    "speaker.pyke": ("Tally-foreman Pyke", "Pyke Mandor Hitung"),
    "speaker.penn": ("Soot-boy Penn", "Penn si Bocah Jelaga"),
    "speaker.clod": ("Old Clod", "Clod si Tua"),
    "speaker.ferra": ("Rack-warden Ferra", "Ferra Penjaga Rak"),
    "speaker.kell": ("Kell the Carter", "Kell si Kusir"),
    "place.Burnpits": ("The Burnpits", "Lubang Bakar"),
    "prompt.travel.burnpits": ("Take the burners' road to the pits", "Tempuh jalan pembakar ke lubang bakar"),
    "prompt.travel.burnpitsOut": ("Walk the burners' road back to the pans", "Kembali menyusuri jalan pembakar ke petak"),
    "event.char.pits": ("Wood-poachers strip the clamps.", "Pemencol kayu membuka klamp-klamp."),
    "event.char.rod": ("The rod's 'borrowers' object.", "'Peminjam' tongkat ukur berkeberatan."),
    "toast.charPits": ("The burn ground stands clear", "Tanah pembakaran sudah bersih"),
    # The Windrest: the mill knoll north of town — Corl's vanes, Bryd's sticks, Tam's sacks.
    "speaker.corl": ("Miller Corl", "Miller Corl"),
    "speaker.bryd": ("Bryd of the Count", "Bryd si Penghitung"),
    "speaker.tam": ("Tam the Mill-lad", "Tam si Anak Giling"),
    "speaker.odo": ("Odo the Weigher", "Odo si Penimbang"),
    "speaker.odle": ("Odle the Carter", "Odle si Kusir"),
    "place.Windrest": ("The Windrest", "Bukit Windrest"),
    "prompt.travel.windrest": ("Take the north lane up to the Windrest", "Tempuh lorong utara ke Bukit Windrest"),
    "prompt.travel.windrestOut": ("Walk the lane back down to Rennfall", "Kembali menyusuri lorong ke Rennfall"),
    "event.mill.field": ("Grain-raiders cut through the stooks.", "Perampok gandum menerobos barisan berkas."),
    "toast.millField": ("The field stands clear", "Ladangnya sudah bersih"),
    # The Chalkpit: the League's dead lime workings — Brack's rim, Ines's count, Simm's stamp.
    "speaker.brack": ("Foreman Brack", "Mandor Brack"),
    "speaker.ines": ("Tally-clerk Ines", "Juru Hitung Ines"),
    "speaker.simm": ("Seal-warden Simm", "Penjaga Segel Simm"),
    "speaker.ket": ("Ket of the Floor", "Ket dari Lantai Lubang"),
    "speaker.rill": ("Cutter Rill", "Pemahat Rill"),
    "speaker.dess": ("Dess the Porter", "Dess si Porter"),
    "place.Chalkpit": ("The Chalkpit", "Lubang Kapur"),
    "prompt.travel.chalkpit": ("Take the chalk spur to the pit", "Tempuh simpangan kapur ke lubang"),
    "prompt.travel.chalkpitOut": ("Walk the spur back to the trade road", "Kembali menyusuri simpangan ke jalan dagang"),
    "event.pit.floor": ("Pit-jacks squat the cut.", "Para pit-jack menduduki galian."),
    "event.pit.seal": ("The stamp's watchers object.", "Para penjaga stempel berkeberatan."),
    "toast.pitClear": ("The pit floor stands clear", "Lantai lubang sudah bersih"),
    # The Stampworks: the coiners' yard above the pit — Novak's books, Jory's plate, Wicke's blanks.
    "speaker.novak": ("Clerk Novak", "Juru Tulis Novak"),
    "speaker.vall": ("Cook Vall", "Juru Masak Vall"),
    "speaker.jory": ("Die-setter Jory", "Penyetel Die Jory"),
    "speaker.wicke": ("Runner Wicke", "Pelari Wicke"),
    "speaker.yard_hand": ("Yard hand", "Kuli halaman"),
    "place.Stampworks": ("The Stampworks", "Percetakan Segel"),
    "prompt.travel.stampworks": ("Take the spur up to the coiners' yard", "Naiki simpangan ke halaman para pencetak"),
    "prompt.travel.stampworksOut": ("Walk the spur back down to the pit", "Kembali menyusuri simpangan ke lubang"),
    "event.stamp.yard": ("The coiners' watch closes in.", "Penjaga para pencetak merapat."),
    ...
    "speaker.ansel": ("Charter Warden Ansel", "Warden Piagam Ansel"),
    "speaker.halvard": ("Halvard the Cutter", "Halvard si Pemahat"),
    "boss.halvard": ("Halvard the Cutter", "Halvard si Pemahat"),
    "speaker.annet": ("Widow Annet", "Janda Annet"),
    "speaker.joss": ("Tollman Joss", "Petugas Tol Joss"),
    "speaker.pike": ("Boy Pike", "Bocah Pike"),
    "speaker.effa": ("Clerk Effa", "Juru Tulis Effa"),
    "speaker.toll_porter": ("A Toll Porter", "Kuli Tol"),
    "speaker.ossel": ("Ossel the Head Drover", "Ossel Kepala Penggembala"),
    "speaker.brigid": ("Cook Brigid", "Brigid si Juru Masak"),
    "speaker.pate": ("Harness-boy Pate", "Pate Anak Pelana"),
    "speaker.fen": ("Old Fen", "Fen Tua"),
    "speaker.nell": ("Whip Nell", "Nell si Tukang Cemeti"),
    "speaker.drover": ("A Drover", "Penggembala"),
    "prompt.travel.tollbank": ("Take the spur north to the Tollbank", "Naiki simpangan utara ke Benteng Tol"),
    "prompt.travel.tollbankOut": ("Walk the spur back to the trade road", "Kembali menyusuri simpangan ke jalan dagang"),
    "prompt.travel.drovers": ("Follow the wagon ruts to the Rest", "Ikuti bekas roda wagon ke Tempat Istirahat"),
    "prompt.travel.droversOut": ("Walk the ruts back to the trade road", "Kembali menyusuri bekas roda ke jalan dagang"),
    "event.toll.breach": ("The washing crew closes at the breach.", "Pasukan cuci merapat di celah bobol."),
    "event.toll.court": ("The court watch takes the yard.", "Jagaan halaman menguasai pelataran."),
    "event.toll.banner": ("They kept watch under their own banner.", "Mereka berjaga di bawah panji sendiri."),
    "event.toll.ledger": ("The last watch stands over the books.", "Penjaga terakhir berdiri di atas buku."),
    "event.drove.corral": ("The pack is at the corral mouth.", "Kawanan itu ada di mulut kandang."),
    "toast.tollBreach": ("The breach is taken", "Celah bobol sudah direbut"),
