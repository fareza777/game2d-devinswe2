...
EFFECTS = {
    ...
    "sword_swing": (0.5, "a smooth controlled sword swing through the air, soft breathy whoosh, muted, no harsh metallic ring"),
    "hit": (0.5, "a dull controlled impact landing on leather armour, soft muted thud, low and rounded, no crack"),
    "enemy_death": (1.4, "a low muffled creature's last breath and a soft collapse onto dirt, subdued, gentle"),
    "player_hurt": (0.6, "a young man's short low restrained grunt of pain, soft and muted, not sharp"),
    "footstep": (0.5, "a single light leather boot footstep on a packed dirt path"),
    "skill_dash": (0.7, "a quick soft lunging whoosh with a muted cloak flutter"),
    "skill_area": (1.5, "a deep controlled wave of fire rolling outward in a ring, low smooth whoosh with soft embers, no explosion"),
    ...
    "enemy_alert": (1.0, "a low wary growl and the soft sound of a blade drawn from leather, subdued"),
